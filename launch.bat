...
REM Start backend
start "TradeJournal Demo - Backend" cmd /k "cd /d %~dp0backend && uvicorn main:app --reload --port 8000"

REM Wait a moment then start frontend
timeout /t 2 /nobreak >nul
start "TradeJournal Demo - Frontend" cmd /k "cd /d %~dp0frontend && npm start"
